    ...
    <form id="booking" class="bottom-panel__wrap d-flex">
        <div class="row bottom-panel__form-wrap">
            <div class="form-group col-date-to col-12 col-sm-6 col-md-4 slash">
                ...
                <input type="text" class="inputFeature input-arrow readonly js-datepicker in" id="check-in" name="check-in" placeholder="Select..." required="required" autocomplete="off">
            </div>
            <div class="form-group col-date-from col-12 col-sm-6 col-md-4 slash">
                <label class="labelFeature" for="check-out">Check out</label>
                <input type="text" class="inputFeature input-arrow readonly js-datepicker out" id="check-out" name="check-out" placeholder="Select..." required="required" autocomplete="off">
            </div>
        ...
        <button type="submit" class="btn-booking" style="font-family: 'Playfair Display', serif">Submit</button>
    </form>
</div>	
<!-- /Booking -->
