    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content" style="border: 0">
            <div class="modal-header">
                <h5 class="modal-title" id="booking-modal-label">Shall we prepare your reservation?</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="rounded mb-3 p-3" style="background: #f4eee1; border: 1px solid #c9a96a; line-height: 1.2rem">
                        <div class="row">
                            ...
                            <div class="col text-center">
                            <div class="labelFeature mb-0">Daily <br><span class="font-weight-bold" style="color: #2c3f58" id="modal-nights"></span></div>
                            </div>
                        </div>
                    </div>
                    <div class="form-group mb-2">
                        <label class="labelFeature mb-0" for="nome">Name</label>
                    ...
                    <div class="form-group mb-2">
                        <label class="labelFeature mb-0" for="phone">Phone/WhatsApp</label>
                        <input type="text" class="inputText" id="phone" name="phone" required="required" autocomplete="off">
                    </div>
                    <div class="small mt-3 mb-1" style="line-height: 0.8rem"><span class="text-danger mr-2">*</span><span class="small">We would like to remind you that, up to this moment, no room availability or rates have been blocked, and they are subject to change without prior notice.</span></div>
                    <div class="small mt-3 mb-3" style="line-height: 0.8rem"><span class="text-danger mr-2">**</span><span class="small">Reservations can also be made by phone/WhatsApp: +55 88 99664-2583.</span></div>
                    <button type="submit" class="btn btn-secondary w-100 d-flex flex-column"><p class="text-center">Check Availability for</p><div class="text-center" id="modal-guests"></div></button>
                </div>
